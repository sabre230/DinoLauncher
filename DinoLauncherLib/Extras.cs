...
public class Extras
{
    public string[] randomStatusMessages =
    {
        ...
        "Ba careful! There are Skeetlas everywhere. Stay close to a lit torch, the light will kill them.", // Randorn
        "And who might you be, animal girl?", //Scales
        "I can't believe the wizard sent a girl to do his dirty work.", // Scales
        "If the princess will not tell me where she has hidden the spellstone, then I will just take everything else, including her life!", // Scales
